...
* 为Linux系统适配桌面图标栏（Tray） ([#603](https://github.com/Kuingsmile/PicList/issues/603)) ([0fe3ade](https://github.com/Kuingsmile/PicList/commit/0fe3ade))
* add $extName for paste template ([64e54d0](https://github.com/Kuingsmile/PicList/commit/64e54d0)), closes [#1000](https://github.com/Kuingsmile/PicList/issues/1000)
* add alias for plugin config name ([5a06483](https://github.com/Kuingsmile/PicList/commit/5a06483))
* add aliyun oss options ([a33f1ad](https://github.com/Kuingsmile/PicList/commit/a33f1ad)), closes [#347](https://github.com/Kuingsmile/PicList/issues/347)
* add autoCopy option for users to use or not ([67e526f](https://github.com/Kuingsmile/PicList/commit/67e526f))
* add baidu tongji for analytics ([f536391](https://github.com/Kuingsmile/PicList/commit/f536391))
* add beta-version update support ([ad6acd8](https://github.com/Kuingsmile/PicList/commit/ad6acd8))
* add commandline argvs support for picgo app ([6db86ec](https://github.com/Kuingsmile/PicList/commit/6db86ec))
* add dist upload to cos & update checkupdate logic ([c926414](https://github.com/Kuingsmile/PicList/commit/c926414))
* add file-name for customurl ([c59e2bc](https://github.com/Kuingsmile/PicList/commit/c59e2bc)), closes [#173](https://github.com/Kuingsmile/PicList/issues/173)
* add file-name in gallery & add unknown-file-type placholder image ([f0787d3](https://github.com/Kuingsmile/PicList/commit/f0787d3)), closes [#1050](https://github.com/Kuingsmile/PicList/issues/1050)
* add file-name in tray-page ([c011654](https://github.com/Kuingsmile/PicList/commit/c011654)), closes [#1054](https://github.com/Kuingsmile/PicList/issues/1054)
* add gallery db ([6ddd660](https://github.com/Kuingsmile/PicList/commit/6ddd660))
* add global value for PicGo get GUI_VERSION & CORE_VERSION ([eab014d](https://github.com/Kuingsmile/PicList/commit/eab014d))
* add gui-api for remove event ([407b821](https://github.com/Kuingsmile/PicList/commit/407b821)), closes [#201](https://github.com/Kuingsmile/PicList/issues/201)
* add i18n for en ([1936ccf](https://github.com/Kuingsmile/PicList/commit/1936ccf))
* add local plugin support && npm registry/proxy support ([f0e1fa1](https://github.com/Kuingsmile/PicList/commit/f0e1fa1))
* add logFileSizeLimit for log file ([219b367](https://github.com/Kuingsmile/PicList/commit/219b367)), closes [#935](https://github.com/Kuingsmile/PicList/issues/935) [#945](https://github.com/Kuingsmile/PicList/issues/945)
* add logs for picgo-server ([2d9e9c0](https://github.com/Kuingsmile/PicList/commit/2d9e9c0)), closes [#627](https://github.com/Kuingsmile/PicList/issues/627)
* add open devtool option ([75e3edc](https://github.com/Kuingsmile/PicList/commit/75e3edc))
* add privacy policy ([992ff35](https://github.com/Kuingsmile/PicList/commit/992ff35))
* add qrcode for picbeds' config ([7fabc47](https://github.com/Kuingsmile/PicList/commit/7fabc47))
* add remote file delete , picBed management ([efeadb8](https://github.com/Kuingsmile/PicList/commit/efeadb8))
* add remoteNotice ([9317871](https://github.com/Kuingsmile/PicList/commit/9317871))
...
* add tencent-cos options for url ([af291e4](https://github.com/Kuingsmile/PicList/commit/af291e4)), closes [#862](https://github.com/Kuingsmile/PicList/issues/862) [#863](https://github.com/Kuingsmile/PicList/issues/863) [#865](https://github.com/Kuingsmile/PicList/issues/865) [#524](https://github.com/Kuingsmile/PicList/issues/524) [#845](https://github.com/Kuingsmile/PicList/issues/845) [#732](https://github.com/Kuingsmile/PicList/issues/732)
* add upload-clipboard-image from electron' clipboard ([27628da](https://github.com/Kuingsmile/PicList/commit/27628da)), closes [#822](https://github.com/Kuingsmile/PicList/issues/822)
* add uploading image from URL support ([a28c678](https://github.com/Kuingsmile/PicList/commit/a28c678))
* add wayland support for linux ([f1c8507](https://github.com/Kuingsmile/PicList/commit/f1c8507))
* add win32 support ([1657542](https://github.com/Kuingsmile/PicList/commit/1657542)), closes [#632](https://github.com/Kuingsmile/PicList/issues/632)
* add windows context menu ([e5fbe75](https://github.com/Kuingsmile/PicList/commit/e5fbe75))
* add workflow for mac ([7f17697](https://github.com/Kuingsmile/PicList/commit/7f17697))
* add zh-TW.yml ([#976](https://github.com/Kuingsmile/PicList/issues/976)) ([72371de](https://github.com/Kuingsmile/PicList/commit/72371de))
...
* finish all-select && shift multi-select ([2aeca50](https://github.com/Kuingsmile/PicList/commit/2aeca50)), closes [#342](https://github.com/Kuingsmile/PicList/issues/342)
* finish custom config path ([7030f7a](https://github.com/Kuingsmile/PicList/commit/7030f7a)), closes [#255](https://github.com/Kuingsmile/PicList/issues/255)
...
* tray-window add open-setting-window button ([83ab3c6](https://github.com/Kuingsmile/PicList/commit/83ab3c6))
* update tray icon in macOS 11 or 12 ([4ebdc72](https://github.com/Kuingsmile/PicList/commit/4ebdc72)), closes [#776](https://github.com/Kuingsmile/PicList/issues/776)
